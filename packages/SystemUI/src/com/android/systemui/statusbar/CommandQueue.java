...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_SET_NAVIGATION_ICON_HINTS  = 18 << MSG_SHIFT;
    private static final int MSG_SET_WINDOW_STATE           = 19 << MSG_SHIFT;
    private static final int MSG_SET_AUTOROTATE_STATUS      = 20 << MSG_SHIFT;
    private static final int MSG_TOGGLE_NOTIFICATION_SHADE  = 21 << MSG_SHIFT;
    private static final int MSG_TOGGLE_QS_SHADE            = 22 << MSG_SHIFT;
